...
/* -------------------------------------------------- */
/*  Accordion Section (drawer mobile nav)             */
/* -------------------------------------------------- */
...
/* -------------------------------------------------- */
/*  HeaderShell — interactive wrapper (client only)  */
/* -------------------------------------------------- */
...
type Props = {
  ...
  navLabels: NavLabels;
  /** Server-rendered desktop nav slot */
  desktopNav: React.ReactNode;
  /** Server-rendered top nav links (ja only) */
  topNav: React.ReactNode;
  /** Server-rendered logo */
  logo: React.ReactNode;
  /** Server-rendered tagline (ja only) */
  tagline: React.ReactNode;
  /** Server-rendered dev admin link (dev only) */
  devLink?: React.ReactNode;
};
