...
import type { RecommendLabels } from "@/lib/i18n-labels";
...
export default function SpotRecommended({ spots, labels, localeSlug }: Props) {
  if (spots.length === 0) return null;

  return (
    <section className="related-section">
      <h3 className="related-heading">{labels.heading}</h3>
