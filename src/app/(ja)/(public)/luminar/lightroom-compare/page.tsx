...
const META = {
  ...
  title: 'Luminar NeoとLightroom徹底比較｜料金・機能・使いやすさの違いを解説',
...
const TOC: TocItem[] = [
  { id: 'conclusion', level: 2, text: '使い方でLightroomとLuminar Neoを選ぶ' },
  { id: 'fit-lightroom', level: 3, text: 'Lightroomが向いている人' },
  { id: 'fit-luminar', level: 3, text: 'Luminar Neoが向いている人' },
  { id: 'price', level: 2, text: 'LightroomとLuminar Neoの料金比較（買い切り vs サブスク）' },
  { id: 'price-lightroom', level: 3, text: 'Lightroomの料金体系' },
  { id: 'price-luminar', level: 3, text: 'Luminar Neoの料金体系' },
  { id: 'price-5years', level: 3, text: '5年間使い続けた場合の総支払額を比較' },
  { id: 'lightroom-buyout', level: 2, text: 'Lightroomに買い切り版はない' },
  { id: 'lr-annual', level: 3, text: 'Lightroomの料金は年いくらか' },
  { id: 'lr-classic', level: 3, text: 'LightroomとLightroom Classicの違い' },
  { id: 'features', level: 2, text: 'LightroomとLuminar NeoのRAW現像・AI・合成の機能比較' },
  { id: 'feature-basic', level: 3, text: '基本的な現像機能の違い' },
  { id: 'feature-ai', level: 3, text: 'AI補正機能の違い' },
  { id: 'feature-composite', level: 3, text: '合成・特殊表現の違い' },
  { id: 'genre', level: 2, text: '撮影ジャンルでLightroomとLuminar Neoを選ぶ' },
  { id: 'genre-landscape', level: 3, text: '風景・夜景' },
  { id: 'genre-portrait', level: 3, text: 'ポートレート' },
  { id: 'genre-product', level: 3, text: '商品・商用写真' },
  { id: 'migration', level: 2, text: 'LightroomからLuminar Neoに乗り換えるときの注意点' },
  { id: 'faq', level: 2, text: 'LightroomとLuminar Neoのよくある質問' },
  ...
  return (
    <LuminarArticleLayout {...META} categoryIds={[1]} toc={TOC} lead={lead}>
      ...
      <section id="conclusion" className="content-card card-padding article-body">
        ...
        <h3 id="fit-luminar">Luminar Neoが向いている人</h3>
        <p>逆に、現像は目的ではなく手段だという人はLuminar Neo寄りです。時間と支払い方の2点で差が出ます。</p>
        <div className="definition">
          <dl className="definition-body">
      ...
      <section id="price" className="content-card card-padding article-body">
        ...
        <h3 id="price-luminar">Luminar Neoの料金体系</h3>
        ...
        <h3 id="price-5years">5年間使い続けた場合の総支払額を比較</h3>
      ...
      */}
      <section id="lightroom-buyout" className="content-card card-padding article-body">
        ...
        <h3 id="lr-classic">LightroomとLightroom Classicの違い</h3>
      ...
      <section id="features" className="content-card card-padding article-body">
        ...
        <h3 id="feature-composite">合成・特殊表現の違い</h3>
      ...
      <section id="genre" className="content-card card-padding article-body">
        <h2>撮影ジャンルでLightroomとLuminar Neoを選ぶ</h2>
        ...
        <div className="m-media-box">
          ...
          <div className="m-media-body">
            ...
            <p>夜景で効いてくるのはノイズ除去の質です。もう一段きれいに消したいときは<strong>Proツール「Noiseless AI」</strong>（買い切りライセンスに標準搭載）を使います。ディテールを残したままノイズだけ落としてくれます。</p>
          </div>
        </div>
        ...
        <div className="m-media-box">
          ...
          <div className="m-media-body">
            ...
            <p>ただし毛穴単位の処理や複雑なシミの除去まで追い込むならPhotoshopの領域です。撮って出しに近い自然な仕上がりを効率よく作りたい、という用途にLuminar Neoは向いています。</p>
          </div>
        </div>
        ...
        <div className="m-media-box">
          ...
          <div className="m-media-body">
            ...
            <p>点数が多いのも商品撮影の特徴です。大量の写真に同じ設定を当てるカタログ機能と同期機能は、ここで効いてきます。AIで1枚ずつ仕上げるLuminar Neoとは、そもそも前提が違います。</p>
          </div>
        </div>
      </section>
      ...
      <section id="faq" className="content-card card-padding article-body">
        <h2>LightroomとLuminar Neoのよくある質問</h2>
        <p>比較記事で繰り返し聞かれる疑問を6つまとめました。</p>
        <dl>
          ...
          <div id="faq-6" className="faq-item">
            ...
            <dd className="faq-a">基本機能（Sky AI、補正AI、電線除去など）は永久に使えます。1年で期限が切れるのは「GenErase」「GenSwap」「GenExpand」という3つの生成AI機能のみで、継続利用にはLuminar Primeの契約が必要です。なお、Proツールも買い切りに含まれており永続的に使えます。</dd>
          </div>
        </dl>
      </section>
