        ...
        <div className="l-article-container">
          ...
          <article itemScope itemType="https://schema.org/WebPage">
            ...
            <div className="m-page-lead">
              ...
              {/* 2026/8/5 に Luminar Neo は「Luminar」へ改名された。検索はまだ旧名が中心なので、
                  title・本文では旧名を残し、改名の事実だけここで断っておく。 */}
              <p>
                2026年8月に製品名が Luminar Neo から「Luminar」に変わりました。
                このサイトでは検索されやすい旧名 Luminar Neo も併記しています。
              </p>
              <p>
