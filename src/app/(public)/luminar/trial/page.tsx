    ...
    <LuminarArticleLayout {...META} categoryIds={[1]} toc={TOC} lead={lead}>
      ...
      <section id="what-can-do" className="content-card card-padding article-body">
        ...
        <div className="m-link-box">
          ...
          <p className="m-link-box__text">どの機能が強みなのか詳しく知りたい方は<a href="/luminar/merit-demerit/">Luminar Neoの良い点・イマイチな点</a>をご覧ください。</p>
        </div>
      </section>

      <section id="why-safe" className="content-card card-padding article-body">
        <h2>無料体験版が安心して使える3つの理由</h2>
        <p><img decoding="async" src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/luminar-neo-plan-trial.jpg" alt="Luminar Neoの無料体験版が安心して使える3つの理由" /></p>
      ...
      <section id="caution" className="content-card card-padding article-body">
        ...
        <div className="m-link-box">
          ...
          <p className="m-link-box__text">「そもそもLuminar Neoが自分の環境に合っているか？」と悩んでいる方は<a href="/luminar/lightroom-compare/">LightroomとLuminar Neoの比較記事</a>も参考にしてみてください。</p>
        </div>
      </section>
      ...
      <section id="what-to-check" className="content-card card-padding article-body">
        ...
        <div className="m-link-box">
          ...
          <p className="m-link-box__text">「長く使う価値があるかの最終判断」をしたい方は<a href="/luminar/">Luminar Neo長期使用レビュー</a>もあわせてご覧ください。</p>
        </div>
      </section>
      ...
      <section id="summary" className="content-card card-padding article-body">
        ...
        <p>使用感が特に問題なかったら、ぜひ<a href="/luminar/sale-and-coupon-info/">Luminar Neoを安く買う方法</a>なども参考にして、お得にLuminar Neoを購入して素敵なフォトライフをお過ごしください。</p>
      </section>
