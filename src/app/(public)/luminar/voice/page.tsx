  ...
  return (
    <LuminarArticleLayout {...META} categoryIds={[1]} toc={TOC} lead={lead}>
      ...
      <section id="summary" className="content-card card-padding article-body">
        ...
        <p><img decoding="async" src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/about-luminar-neo.jpg" alt="Luminar Neoの管理画面" /></p>
      ...
      <section id="good" className="content-card card-padding article-body">
        ...
        <div className="m-link-box">
          ...
          <p className="m-link-box__text">AI機能の詳細は<a href="/luminar/expand/">Luminar NeoのProツール（拡張機能）まとめ</a>で解説しています。</p>
        </div>
        ...
        <div className="m-link-box">
          ...
          <p className="m-link-box__text">操作性や機能の違いは<a href="/luminar/lightroom-compare/">Luminar NeoとLightroomの比較記事</a>で詳しく解説しています。</p>
        </div>
      </section>
      ...
      <section id="bad" className="content-card card-padding article-body">
        ...
        <div className="m-link-box">
          ...
          <p className="m-link-box__text">推奨スペックや動作環境は<a href="/luminar/faq/">Luminar NeoのFAQ</a>で確認できます。</p>
        </div>
        ...
        <div className="m-link-box">
          ...
          <p className="m-link-box__text">料金体系の詳細は<a href="/luminar/luminar-plan/">Luminar Neoの料金プラン解説記事</a>で整理しています。</p>
        </div>
      </section>
      ...
      <section id="reality" className="content-card card-padding article-body">
        ...
        <div className="m-link-box">
          ...
          <p className="m-link-box__text">長期使用の詳細レビューは<a href="/luminar/merit-demerit/">Luminar Neoのメリット・デメリット記事</a>で解説しています。</p>
        </div>
      </section>
      ...
      <section id="before-buy" className="content-card card-padding article-body">
        ...
        <div className="m-link-box">
          ...
          <p className="m-link-box__text">体験版のダウンロード方法と制限は<a href="/luminar/trial/">Luminar Neo体験版の解説記事</a>で確認できます。</p>
        </div>
        ...
        <div className="m-link-box">
          ...
          <p className="m-link-box__text">セール時期やクーポン情報は<a href="/luminar/sale-and-coupon-info/">Luminar Neoのセール・クーポン情報記事</a>でまとめています。</p>
        </div>
      </section>
      ...
      <section id="faq" className="content-card card-padding article-body">
        ...
        <div className="m-link-box">
          ...
          <p className="m-link-box__text">その他の質問は<a href="/luminar/faq/">Luminar NeoのFAQ記事</a>にまとめています。</p>
        </div>
      </section>
