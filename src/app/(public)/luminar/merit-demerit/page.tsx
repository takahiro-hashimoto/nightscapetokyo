  ...
  return (
    <LuminarArticleLayout {...META} categoryIds={[2]} toc={TOC} lead={lead}>
      ...
      <section id="about" className="content-card card-padding article-body">
        ...
        <p><img decoding="async" src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/about-luminar-neo.jpg" alt="Luminar Neo（ルミナーネオ）の編集画面" /></p>
      ...
      <section id="merits" className="content-card card-padding article-body">
        ...
        <p><img decoding="async" src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/luminar-neo-edit.jpg" alt="Luminar Neoの編集画面" /></p>
        ...
        <div className="comparison-container">
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/magic-light-before.jpeg" alt="ルミナーネオのRAW現像+マジックライトAIを適用する前の作例" className="image-before" />
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/magic-light-after2.jpeg" alt="ルミナーネオのRAW現像+マジックライトAIを適用した後の作例" className="image-after" />
        ...
        <div className="comparison-container">
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/sogo-before.jpeg" alt="ルミナーネオのトワイライトエンハンサー+太陽光線を適用する前の作例" className="image-before" />
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/sogossfte.jpeg" alt="ルミナーネオのトワイライトエンハンサー+太陽光線を適用した後の作例" className="image-after" />
          <div className="slider-handle">
            <div className="slider-button">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <path d="M18 8l4 4-4 4M6 8l-4 4 4 4"></path>
        ...
        <div className="comparison-container">
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/sky-before.jpg" alt="スカイAIで曇り空を青空に入れ替える前の作例" className="image-before" />
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/sky-after2.jpeg" alt="スカイAIで曇り空を青空に入れ替えた後の作例" className="image-after" />
          <div className="slider-handle">
            <div className="slider-button">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <path d="M18 8l4 4-4 4M6 8l-4 4 4 4"></path>
        ...
        <div className="comparison-container">
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/densen-before.jpg" alt="電線除去機能で風景から電線を消す前の作例" className="image-before" />
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/densen-after.jpeg" alt="電線除去機能で風景から電線を消した後の作例" className="image-after" />
          <div className="slider-handle">
            <div className="slider-button">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <path d="M18 8l4 4-4 4M6 8l-4 4 4 4"></path>
        ...
        <div className="comparison-container">
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/dust-before.jpeg" alt="ホコリ除去機能でセンサーゴミを削除する前の作例" className="image-before" />
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/dust-after.jpeg" alt="ホコリ除去機能でセンサーゴミを削除した後の作例" className="image-after" />
          <div className="slider-handle">
            <div className="slider-button">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <path d="M18 8l4 4-4 4M6 8l-4 4 4 4"></path>
        ...
        <div className="comparison-container">
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/portrait-before-scaled.jpeg" alt="ポートレートボケAIで背景ボケを追加する前の作例" className="image-before" />
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/portrait-after.jpg" alt="ポートレートボケAIで背景ボケを追加した後の作例" className="image-after" />
          <div className="slider-handle">
            <div className="slider-button">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <path d="M18 8l4 4-4 4M6 8l-4 4 4 4"></path>
        ...
        <div className="comparison-container">
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/noise-before.jpg" alt="Noiseless AIで高感度ノイズを除去する前の作例" className="image-before" />
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/DSC08329.jpg" alt="Noiseless AIで高感度ノイズを除去した後の作例" className="image-after" />
          <div className="slider-handle">
            <div className="slider-button">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <path d="M18 8l4 4-4 4M6 8l-4 4 4 4"></path>
        ...
        <div className="comparison-container">
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/hdr-before.jpeg" alt="HDR Mergeで露出違いの写真を合成する前の作例" className="image-before" />
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/hdr-after.jpeg" alt="HDR Mergeで露出違いの写真を合成した後の作例" className="image-after" />
          <div className="slider-handle">
            <div className="slider-button">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <path d="M18 8l4 4-4 4M6 8l-4 4 4 4"></path>
        ...
        <div className="comparison-container">
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/supershape-before.jpg" alt="スーパーシャープで手ブレを補正する前の作例" className="image-before" />
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/supershape-after.jpeg" alt="スーパーシャープで手ブレを補正した後の作例" className="image-after" />
          <div className="slider-handle">
            <div className="slider-button">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <path d="M18 8l4 4-4 4M6 8l-4 4 4 4"></path>
        ...
        <div className="comparison-container">
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/gene-bofore.jpg" alt="ジェネ変換で雲をマジックアワーの空に変える前の作例" className="image-before" />
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/gene-ater.jpeg" alt="ジェネ変換で雲をマジックアワーの空に変えた後の作例" className="image-after" />
          <div className="slider-handle">
            <div className="slider-button">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <path d="M18 8l4 4-4 4M6 8l-4 4 4 4"></path>
        ...
        <div className="comparison-container">
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/ai-gen-delete-before.jpeg" alt="ジェネ消去機能で不要なオブジェクトを削除する前の作例" className="image-before" />
          <img src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/ai-gen-delete-after.jpeg" alt="ジェネ消去機能で不要なオブジェクトを削除した後の作例" className="image-after" />
          <div className="slider-handle">
            <div className="slider-button">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <path d="M18 8l4 4-4 4M6 8l-4 4 4 4"></path>
        ...
        <p><img decoding="async" src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/layer.jpg" alt="Luminer Neoのレイヤー機能で合成・レタッチも1本で完結" /></p>
        ...
        <p><img decoding="async" src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/luminar-neo-catalog-scaled.jpg" alt="Luminar Neoのカタログ機能" /></p>
        ...
        <p><i className="fa-solid fa-arrow-right"></i> <a href="/luminar/luminar-plan/">料金プランの詳細とコストシミュレーション</a></p>
      </section>
      ...
      <section id="demerits" className="content-card card-padding article-body">
        ...
        <p><img decoding="async" src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/macboook-air-use-image.jpg" alt="MacBookでLuminar Neoを操作する様子" /></p>
        ...
        <p><img decoding="async" src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/lightroom-display-scaled.jpg" alt="Lightroomの管理画面" /></p>
        ...
        <p><img decoding="async" src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/luminar-neo-edit-03.jpg" alt="Luminar Neoの編集画面" /></p>
      ...
      <section id="ending" className="content-card card-padding article-body">
        ...
        <p><img decoding="async" src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/sony-sel40f25g-image.webp" alt="SONYのカメラを手に取る様子" /></p>
