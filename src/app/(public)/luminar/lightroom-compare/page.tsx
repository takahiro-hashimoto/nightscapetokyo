    ...
    <LuminarArticleLayout {...META} categoryIds={[1]} toc={TOC} lead={lead}>
      ...
      <section id="genre" className="content-card card-padding article-body">
        ...
        <div className="m-media-box">
          <img decoding="async" src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/dust-after-1.jpeg" alt="風景写真の作例" className="m-media-img" />
        ...
        <h3>ポートレート</h3>
        <div className="m-media-box">
          <img decoding="async" src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/portrait-after.jpg" alt="ポートレート写真の作例" className="m-media-img" />
          <div className="m-media-body">
        ...
        <h3>商品・商用写真</h3>
        <div className="m-media-box">
          <img decoding="async" src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/MH40.jpg" alt="商品写真の作例" className="m-media-img" />
          <div className="m-media-body">
