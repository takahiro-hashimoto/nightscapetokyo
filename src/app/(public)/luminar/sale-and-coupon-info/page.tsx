  ...
  return (
    <LuminarArticleLayout {...META} categoryIds={[1]} toc={TOC} lead={lead}>
      ...
      <section id="how-to-save" className="content-card card-padding article-body">
        ...
        <p><img decoding="async" src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/luminar-neo-sale.jpg" alt="Luminar Neoを安く買う3つの方法" /></p>
        ...
        <div style={{ position: 'relative' }}>
          <div className="m-step">
            ...
            <div className="m-step__content">
              ...
              <p><img decoding="async" src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/luminar-cuopon-01.jpg" alt="Luminar Neoの購入方法、クーポンの使い方 ステップ1" /></p>
            </div>
          </div>
          <div className="m-step">
            <div className="m-step__line"></div>
            ...
            <div className="m-step__content">
              ...
              <p><img decoding="async" src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/luminar-cuopon-02.jpg" alt="Luminar Neoの購入方法、クーポンの使い方 ステップ2" /></p>
            </div>
          </div>
          <div className="m-step">
            ...
            <div className="m-step__content">
              ...
              <p><img decoding="async" src="https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/luminar/luminar-cuopon-03.jpg" alt="Luminar Neoの購入方法、クーポンの使い方 ステップ3" /></p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="pricing" className="content-card card-padding article-body">
        ...
        <p>「アップグレードパス」「エコシステムパス」の違いや、Luminarの長期利用のコストについては<a href="/luminar/luminar-plan/">Luminar Neoの料金体系を徹底解説</a>で詳しく解説しています。</p>
      </section>
