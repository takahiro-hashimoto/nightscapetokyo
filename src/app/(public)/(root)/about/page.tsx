...
const ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    ...
    link: {
      ...
      siteName: "東京夜景ナビ",
      thumbnail: "https://pub-7d430b8241bc4d38b717b9e2905120d8.r2.dev/uploads/2024/02/21.jpg",
          ...
          <div key={a.title}>
            ...
            >
              ...
              <div className="ref-body">
                <span className="ref-title">{a.link.title}</span>
                {a.link.siteName && (
                  <span className="ref-site">{a.link.siteName}</span>
                )}
                {a.link.excerpt && (
                  <span className="ref-excerpt">{a.link.excerpt}</span>
                )}
              </div>
