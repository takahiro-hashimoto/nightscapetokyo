...
export const ABOUT_LABELS: Record<string, AboutLabels> = {
  ja: {
    title: "運営者情報",
    ...
    bio: [
      ...
      "東京都内のメジャーな夜景スポットはほぼ制覇しており、最近は夜景が綺麗な都内のホテルに宿泊して客室からの眺めを堪能するのがマイブーム。",
      "本サイトの他にも「ガジェットレビューブログ・デジスタ」、「ユーズドラボ」、「ビズシェルフ」を運営していたり、カメラマン、Webコンサルタントとしても活動しています。",
    ],
    equipment: "撮影機材について",
    equipmentDesc: "夜景写真の撮影には下記のようなアイテムを使用しています。",
    equipmentArticleHref: "https://nightscape.tokyo/article/my-photographic-equipment/",
    equipmentArticleText: "夜景フォトグラファーの愛用する撮影機材まとめ",
    achievements: "活動実績",
    achievementsDesc: "本サイトを通じてご依頼いただいたお仕事などの活動実績を一部ご紹介します。",
    achievementTitles: [
      "株式会社TOKYO TOWER様 PC版トップページのタイムラプス映像を撮影",
      "ザ・プリンス パークタワー東京様の客室・レストランのプロモーション用写真を撮影",
      "ザ・プリンス パークタワー東京様 リニューアルプロジェクト用写真撮影",
      "名古屋プリンスホテルスカイタワー様の客室からの眺望を撮影",
      "動画コンテスト「港、動く 15秒の物語」の審査員を担当",
      "日本電設工業株式会社 Webサイトのメインビジュアルを納品",
      "ヘリコプター遊覧サービスのAIROS Skyview PR記事を作成",
      "レストランルークの期間限定イベント「SKY TERRACE」の取材記事を担当",
      "第8回東京大回廊写真コンテスト 出光美術館賞を受賞",
      "BS TBS カンニング竹山の昼酒は人生の味。にタイムラプス映像を提供",
      "NHK総合「〜天才ピアニスト 10年の空白を越えて〜」にタイムラプス映像を提供",
      "テレビ朝日「ザワつく!金曜日」に写真素材を提供",
      "朝日新聞のコラムにインタビュー記事が掲載",
    ],
    achievementDescs: [
      [
      ...
      [
        "名古屋プリンスホテルスカイタワー様の客室からの夜景写真、タイムラプス映像を撮影させていただきました。",
        "公式サイト、楽天トラベル、じゃらんといった旅行サイトの素材として使用いただいております。",
      ],
      [
        "港区のナイトスポットの魅力を発信することを目的とした動画コンテスト「港、動く 15秒の物語」の審査員を担当。",
    ...
    contactHeading: "夜景撮影のご依頼や写真素材等の購入はお気軽にお問い合わせください。",
    contactCta: "お問い合わせ・撮影依頼",
  },
  ...
  cn: {
    ...
    achievementDescs: [
      ...
      ["受运营直升机游览服务AIROS Skyview的AirX委托，撰寫了PR文章。", "这是一项能在非日常体验中欣赏东京夜景的绝佳服务。"],
