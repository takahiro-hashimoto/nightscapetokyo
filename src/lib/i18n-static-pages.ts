...
// ── Contact ──
export const CONTACT_LABELS: Record<string, StaticPageLabels & { intro: string; aboutLink: string }> = {
  ja: {
    title: "お問い合わせ",
    summary: "写真・映像の購入や撮影のご依頼等のお問い合わせは下記のフォームからお願いいたします。",
    description: "東京夜景ナビへのお問い合わせページです。写真・映像の購入や撮影のご依頼等はこちらのフォームからお願いいたします。",
    intro: "基本的に24時間以内にお返事させていただきますので、お気軽にお問い合わせください！",
    aboutLink: "東京夜景ナビ 運営者情報と活動実績 →",
  },
  en: {
    title: "Contact",
    summary: "For inquiries about photo/video purchases or shooting requests, please use the form below.",
    ...
    intro: "We will typically respond within 24 hours. Feel free to reach out!",
    aboutLink: "About the Operator & Achievements →",
  },
  ko: {
    title: "문의하기",
    summary: "사진·영상 구매나 촬영 의뢰 등의 문의는 아래 양식을 이용해 주세요.",
    description: "도쿄 야경 네비 문의 페이지입니다. 사진·영상 구매나 촬영 의뢰는 양식을 이용해 주세요.",
    intro: "기본적으로 24시간 이내에 답변 드리겠습니다. 편하게 문의해 주세요!",
    aboutLink: "운영자 정보 및 활동 실적 →",
  },
  tw: {
    title: "聯絡我們",
    summary: "如需購買照片·影片或委託拍攝，請透過下方表單聯絡我們。",
    description: "東京夜景導覽聯絡頁面。如需購買照片·影片或委託拍攝，請使用表單聯絡。",
    intro: "我們通常會在24小時內回覆，歡迎隨時聯絡！",
    aboutLink: "關於營運者與活動實績 →",
  },
  cn: {
    title: "联系我们",
    summary: "如需购买照片·视频或委托拍摄，请通过下方表单联系我们。",
    description: "东京夜景导航联系页面。如需购买照片·视频或委托拍摄，请使用表单联系。",
    intro: "我们通常会在24小时内回复，欢迎随时联系！",
    aboutLink: "关于运营者与活动业绩 →",
  },
};
...
// ── Sitemap ──
export const SITEMAP_LABELS: Record<string, StaticPageLabels & { areaHeading: string; tagHeading: string; pageHeading: string }> = {
  ja: { title: "サイトマップ", summary: "東京夜景ナビに掲載中の全ページへのリンク一覧です。", description: "東京夜景ナビのサイトマップです。", areaHeading: "エリア別 夜景スポット", tagHeading: "目的別 夜景スポット", pageHeading: "固定ページ" },
  en: { title: "Sitemap", summary: "A list of all pages published on Tokyo Night View Guide.", description: "Sitemap for Tokyo Night View Guide.", areaHeading: "Night View Spots by Area", tagHeading: "Night View Spots by Purpose", pageHeading: "Pages" },
  ko: { title: "사이트맵", summary: "도쿄 야경 네비에 게재된 모든 페이지 링크 목록입니다.", description: "도쿄 야경 네비 사이트맵입니다.", areaHeading: "지역별 야경 스폿", tagHeading: "목적별 야경 스폿", pageHeading: "고정 페이지" },
  tw: { title: "網站地圖", summary: "東京夜景導覽所有頁面的連結一覽。", description: "東京夜景導覽網站地圖。", areaHeading: "按地區的夜景景點", tagHeading: "按目的的夜景景點", pageHeading: "固定頁面" },
  cn: { title: "网站地图", summary: "东京夜景导航所有页面的链接列表。", description: "东京夜景导航网站地图。", areaHeading: "按地区的夜景景点", tagHeading: "按目的的夜景景点", pageHeading: "固定页面" },
};
