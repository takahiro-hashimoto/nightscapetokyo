/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/cron/wrangler.jsonc --env-interface=CronEnv workers/cron/worker-configuration.d.ts` (hash: 2ef3c0250085ef2d665d625bac219ee5)
// Runtime types generated with workerd@1.20260811.1 2025-08-01 
interface __BaseEnv_CronEnv {
	SITE_URL: "https://nightscape.tokyo";
}
